...
urlpatterns = patterns('',
    ...
    url(r'^compositions/(?P<pk>\d+)/like/$', views.CompositionLike.as_view(), name='composition_like'),
    url(r'^compositions/(?P<pk>\d+)/favorite/$', views.CompositionLike.as_view(), name='composition_favorite'),
    ...
    url(r'^parts/(?P<pk>\d+)/like/$', views.PartLike.as_view(), name='part_like'),
